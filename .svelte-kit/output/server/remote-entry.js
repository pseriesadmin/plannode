...
import { C as stringify_remote_arg, p as create_remote_key, D as unfriendly_hydratable, f as noop, M as MUTATIVE_METHODS, F as create_field_proxy, G as normalize_issue, H as set_nested_value, J as flatten_issues, K as deep_set, v as stringify, b as browser, h as handle_error_and_jsonify, u as parse_remote_arg } from "./chunks/shared.js";
...
async function get_response(internals, arg, state, get_result) {
  ...
  if (state.is_in_render && internals.id) {
    create_remote_key(internals.id, key);
